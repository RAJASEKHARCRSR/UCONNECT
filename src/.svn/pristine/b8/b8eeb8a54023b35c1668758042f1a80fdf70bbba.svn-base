...
Section "MainSection" SEC01
 ...
 File "D:\workspace\ReleasePackage\x64\bin\altair_310511_virtualcom64.cat"
  File "D:\workspace\ReleasePackage\x64\bin\common_ioctl.lib"
  File "D:\workspace\ReleasePackage\x64\bin\lte_ctrl.inf"
  File "D:\workspace\ReleasePackage\x64\bin\lte_ctrl.sys"
  File "D:\workspace\ReleasePackage\x64\bin\lte_dev.inf"
  File "D:\workspace\ReleasePackage\x64\bin\lte_dev.sys"
  File "D:\workspace\ReleasePackage\x64\bin\lte_diag.sys"
  File "D:\workspace\ReleasePackage\x64\bin\lte_diag64.cat"
  File "D:\workspace\ReleasePackage\x64\bin\lte_diag_device.inf"
  File "D:\workspace\ReleasePackage\x64\bin\lte_diag_driver.inf"
  File "D:\workspace\ReleasePackage\x64\bin\lte_net.inf"
  File "D:\workspace\ReleasePackage\x64\bin\lte_net.sys"
  File "D:\workspace\ReleasePackage\x64\bin\lte_net64.cat"
  File "D:\workspace\ReleasePackage\x64\bin\VirtualCOM.dll"
  File "D:\workspace\ReleasePackage\x64\bin\VirtualCom.inf"
  File "D:\workspace\ReleasePackage\x64\bin\WdfCoInstaller01009.dll"
  File "D:\workspace\ReleasePackage\x64\bin\WUDFUpdate_01009.dll"
  SetOutPath "$INSTDIR\x64"
  ...
  File "D:\workspace\ReleasePackage\x86\bin\altair_310511_virtualcom86.cat"
  File "D:\workspace\ReleasePackage\x86\bin\common_ioctl.lib"
  File "D:\workspace\ReleasePackage\x86\bin\lte_ctrl.inf"
  File "D:\workspace\ReleasePackage\x86\bin\lte_ctrl.sys"
  File "D:\workspace\ReleasePackage\x86\bin\lte_dev.inf"
  File "D:\workspace\ReleasePackage\x86\bin\lte_dev.sys"
  File "D:\workspace\ReleasePackage\x86\bin\lte_diag.sys"
  File "D:\workspace\ReleasePackage\x86\bin\lte_diag86.cat"
  File "D:\workspace\ReleasePackage\x86\bin\lte_diag_device.inf"
  File "D:\workspace\ReleasePackage\x86\bin\lte_diag_driver.inf"
  File "D:\workspace\ReleasePackage\x86\bin\lte_net.inf"
  File "D:\workspace\ReleasePackage\x86\bin\lte_net.sys"
  File "D:\workspace\ReleasePackage\x86\bin\lte_net86.cat"
  File "D:\workspace\ReleasePackage\x86\bin\VirtualCOM.dll"
  File "D:\workspace\ReleasePackage\x86\bin\VirtualCom.inf"
  File "D:\workspace\ReleasePackage\x86\bin\WdfCoInstaller01009.dll"
  File "D:\workspace\ReleasePackage\x86\bin\WUDFUpdate_01009.dll"
  SetOutPath "$INSTDIR\x86"
...
Section Uninstall
 ...
 Delete "$INSTDIR\x86\wdreg.exe"
  ...
  Delete "$INSTDIR\x86\bin\WUDFUpdate_01009.dll"
  Delete "$INSTDIR\x86\bin\WdfCoInstaller01009.dll"
  Delete "$INSTDIR\x86\bin\VirtualCom.inf"
  Delete "$INSTDIR\x86\bin\VirtualCOM.dll"
  Delete "$INSTDIR\x86\bin\lte_net86.cat"
  Delete "$INSTDIR\x86\bin\lte_net.sys"
  Delete "$INSTDIR\x86\bin\lte_net.inf"
  Delete "$INSTDIR\x86\bin\lte_diag_driver.inf"
  Delete "$INSTDIR\x86\bin\lte_diag_device.inf"
  Delete "$INSTDIR\x86\bin\lte_diag86.cat"
  Delete "$INSTDIR\x86\bin\lte_diag.sys"
  Delete "$INSTDIR\x86\bin\lte_dev.sys"
  Delete "$INSTDIR\x86\bin\lte_dev.inf"
  Delete "$INSTDIR\x86\bin\lte_ctrl.sys"
  Delete "$INSTDIR\x86\bin\lte_ctrl.inf"
  Delete "$INSTDIR\x86\bin\common_ioctl.lib"
  Delete "$INSTDIR\x86\bin\altair_310511_virtualcom86.cat"
  ...
  Delete "$INSTDIR\x64\bin\WUDFUpdate_01009.dll"
  Delete "$INSTDIR\x64\bin\WdfCoInstaller01009.dll"
  Delete "$INSTDIR\x64\bin\VirtualCom.inf"
  Delete "$INSTDIR\x64\bin\VirtualCOM.dll"
  Delete "$INSTDIR\x64\bin\lte_net64.cat"
  Delete "$INSTDIR\x64\bin\lte_net.sys"
  Delete "$INSTDIR\x64\bin\lte_net.inf"
  Delete "$INSTDIR\x64\bin\lte_diag_driver.inf"
  Delete "$INSTDIR\x64\bin\lte_diag_device.inf"
  Delete "$INSTDIR\x64\bin\lte_diag64.cat"
  Delete "$INSTDIR\x64\bin\lte_diag.sys"
  Delete "$INSTDIR\x64\bin\lte_dev.sys"
  Delete "$INSTDIR\x64\bin\lte_dev.inf"
  Delete "$INSTDIR\x64\bin\lte_ctrl.sys"
  Delete "$INSTDIR\x64\bin\lte_ctrl.inf"
  Delete "$INSTDIR\x64\bin\common_ioctl.lib"
  Delete "$INSTDIR\x64\bin\altair_310511_virtualcom64.cat"
  Delete "$INSTDIR\x64\ALTAIR_LTEMANGER_REG.reg"
  Delete "$INSTDIR\vpn.exe"
  Delete "$INSTDIR\UConnectGUI.exe"
  Delete "$INSTDIR\UConnect.url"
